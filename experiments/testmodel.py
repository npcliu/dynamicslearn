...
def get_dataset(system, T, dt, h5_file_path):
    ...
    test_data = (timestamps_gpu_t[:, 50:54], q_gpu_t[:, 50:54, :], 
                    dq_gpu_t[:, 50:54, :], tau_gpu_t[:, 50:54, :])
...
if __name__ == '__main__':
    ...
    model = torch.load('simplelog/20250331_234321/full_model_epoch_599.pt', weights_only=False, map_location='cpu')
